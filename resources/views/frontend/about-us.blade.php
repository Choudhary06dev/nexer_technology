...
<section id="about" class="main">
    <div class="inner">
        ...
        <p>UI/UX Design</p>
        <p>Cloud Solutions</p>
        <p>API Integration & System Modernization</p>
        <p>Ongoing Support & Maintenance</p>

        <p>Driven by innovation and guided by experience, Nexer Tech Solution is your trusted partner in technology. Let’s build the future together.</p>
    </div>
</section>
