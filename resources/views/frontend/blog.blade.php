...
<section id="blog" class="blog-section-ultra @if(isset($is_index)) index-mode @endif">
    <div class="container-premium">
        ...
        <div class="blog-actions-center ao-fade-up" style="margin-top: 30px; margin-bottom: 30px;">
            ...
            <button id="show-less-btn" class="btn-all-insights btn-show-less" style="display: none;">
                Show Less <i class="fa fa-chevron-up" style="margin-left: 8px;"></i>
            </button>
        </div>
        ...
        <style>
            ...
            .btn-all-insights:hover {
                ...
                box-shadow: 0 15px 30px rgba(0, 77, 230, 0.25);
                color: white !important;
            }
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const hiddenPosts = document.getElementById('hidden-blog-posts');

                if (showMoreBtn && hiddenPosts && showLessBtn) {
                    showMoreBtn.addEventListener('click', function() {
                        hiddenPosts.classList.add('active');
                        showMoreBtn.style.display = 'none';
                        showLessBtn.style.display = 'inline-flex';

                        // Smooth scroll to the first of hidden posts
                        setTimeout(() => {
                            hiddenPosts.scrollIntoView({
                                behavior: 'smooth',
                                block: 'start'
                            });
                        }, 100);
                    ...
                    showLessBtn.addEventListener('click', function() {
                        hiddenPosts.classList.remove('active');
                        showMoreBtn.style.display = 'inline-flex';
                        showLessBtn.style.display = 'none';

                        // Scroll back to the blog section start
