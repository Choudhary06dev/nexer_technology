...
<section id="banner" class="major">
    <div class="inner">
        ...
        <div class="content">
            ...
            <ul class="actions">
                <li><a href="#" class="button next scrolly">Contact us</a></li>
            </ul>
        </div>
    </div>
</section>
...
<div id="main">
    ...
    <section>
        <div class="inner">
            ...
            <p>We connect the dots Between technology, strategy, creativity and industry experts leveraging to build socially impecting solutions.</p>
            <ul class="actions">
                <li><a href="#" class="button next">Read more</a></li>
            </ul>
        </div>
    </section>
